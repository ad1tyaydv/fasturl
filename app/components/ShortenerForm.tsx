    ...
    <>
      ...
      <div className="w-full p-6 sm:p-8 bg-card border border-border rounded-[32px] shadow-sm font-one">
        <div className="flex p-1.5 bg-secondary/60 rounded-full mb-8">
          <button
            onClick={() => { setActiveTab("shorten"); handleReset(); }}
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-full text-base font-medium transition-all cursor-pointer ${activeTab === "shorten" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
          >
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-full text-base font-medium transition-all cursor-pointer ${activeTab === "qr" ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
          >
                ...
                {isLoadingQr ? (
                  ...
                  <div className="flex flex-col items-center animate-in fade-in zoom-in duration-500">
                    <div className="bg-white p-2 rounded-xl border border-border shadow-sm">
                      <img src={showQr} alt="QR Code" className="w-48 h-48 object-contain" width={192} height={192} />
                    </div>
                    <button
