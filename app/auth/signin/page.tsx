      ...
      <div className="w-full lg:w-1/2 p-8 lg:p-20 flex flex-col justify-center bg-background min-h-screen relative">
        ...
        >
          {!show2FA ? (
            <>
              <div className="mb-12">
                <h2 className="text-4xl font-extrabold text-foreground mb-3">Sign In</h2>
              ...
              <div className="relative flex items-center justify-center my-10">
                ...
                <span className="absolute bg-background px-6 text-[11px] text-zinc-500 font-bold uppercase tracking-[0.3em]">or</span>
              </div>

              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 py-4 border border-zinc-800 bg-white text-black rounded-2xl transition-all font-bold shadow-sm cursor-pointer group hover:bg-zinc-50"
            ...
            <div className="flex flex-col items-center text-center">
              <div className="mb-10 flex flex-col items-center">
                ...
                <p className="text-muted-foreground text-lg font-medium max-w-[320px] leading-relaxed">
