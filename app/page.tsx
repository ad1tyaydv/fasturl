      ...
      <section className="max-w-7xl mx-auto px-6 pt-24 pb-20">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full max-w-xl">
            ...
            <div className={`flex flex-col sm:flex-row gap-3 border rounded-2xl p-2 sm:p-3 transition-all shadow-xl bg-[#1a1a1a] ${shortUrl ? 'border-blue-500 ring-4 ring-blue-500/10' : 'border-neutral-800'}`}>
              <input
                type="text"
              ...
              {shortUrl ? (
                <div className="flex gap-2 w-full sm:w-auto">
                  <button onClick={handleGenerateQr} className={`px-4 sm:px-5 py-3 rounded-xl flex items-center justify-center cursor-pointer transition-colors ${showQr ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/20' : 'bg-[#2a2a2a] text-white hover:bg-[#333333]'}`}>
                    <HugeiconsIcon icon={QrCodeIcon} />
                  </button>
                  <button onClick={copyToClipboard} className="flex-1 sm:flex-none px-4 sm:px-8 py-3 rounded-xl bg-blue-600 text-white font-bold flex items-center justify-center gap-2 cursor-pointer hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20">
                    <HugeiconsIcon icon={CopyIcon} />
                  </button>
                  <button onClick={handleReset} className="px-4 sm:px-5 py-3 rounded-xl bg-[#2a2a2a] text-white flex items-center justify-center cursor-pointer hover:bg-[#333333] transition-colors">
                ...
                {showQr && typeof showQr === "string" ? (
                  <div className="flex flex-col items-center animate-in fade-in zoom-in duration-500">
                    ...
                    <button 
                      ...
                      className="mt-6 flex items-center gap-2 px-6 py-2.5 bg-white text-black text-xs font-bold rounded-full hover:bg-gray-200 transition-all shadow-lg"
                    >
